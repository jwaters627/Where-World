app.controller('MainController', ['$scope', function($scope) {
    ...
    $scope.trips = [{
            ...
            number: 71,
            name: 'Acadia',
            description: 'Acadia is located on Mt. Desert Island in Maine. It has amazing coast lines, mountains to hike, lake to relax at and Bar Harbor is a great little town.  You will want to be sure to set your alarms before sunrise, so you can hike or drive to the top of Cadillac Mountain and take in the sunrise.  This is the first place in the United States that sunlight hits and the sunrise is spectacular as it comes up from the water and illuminates the islands below. The Beehive is another spectacular hike that is fairly strenuous, but the view from the top is worth the effort. There are several beaches that you can post up at and relax at after a day of exploring the park.',
            duration: 'Make sure to give yourself at least a weekend in the park, but if you have the time it is worth spending 4 or 5 days exploring the different areas within the park.',
            image: 'dist/img/acadia.jpg'
        }, {
            number: 72,
            name: 'Acadia',
            description: 'Acadia is located on Mt. Desert Island in Maine. It has amazing coast lines, mountains to hike, lake to relax at and Bar Harbor is a great little town.  You will want to be sure to set your alarms before sunrise, so you can hike or drive to the top of Cadillac Mountain and take in the sunrise.  This is the first place in the United States that sunlight hits and the sunrise is spectacular as it comes up from the water and illuminates the islands below. The Beehive is another spectacular hike that is fairly strenuous, but the view from the top is worth the effort. There are several beaches that you can post up at and relax at after a day of exploring the park.',
            ...
            number: 77,
            name: 'Ireland',
            description: 'The emerald isle has many things to do and see, but taking in its largest city is a must see. Beer lovers will want to take a tour of the Guiness brewery and have a beer at its bar with 360 degree views of Dublin. It is certainly worth renting a car or taking a bus to head to the other side of the island to visit Cork and head off to to kiss the Blarney Stone.  People afraid of heights will tremble at The Cliffs of Moher, but this is a sight that should not be missed. ',
            duration: 'Ireland has so much culture and scenery that you should give yourself a full week to take in as much as possible.',
            image: 'dist/img/ireland.jpg'
        }, {
            number: 78,
            name: 'Ireland',
            description: 'The emerald isle has many things to do and see, but taking in its largest city is a must see. Beer lovers will want to take a tour of the Guiness brewery and have a beer at its bar with 360 degree views of Dublin. It is certainly worth renting a car or taking a bus to head to the other side of the island to visit Cork and head off to to kiss the Blarney Stone.  People afraid of heights will tremble at The Cliffs of Moher, but this is a sight that should not be missed. ',
            ...
            number: 84,
            name: 'Vienna',
            description: 'Vienna is a city with a ton of history and unique culture. Walking the Ringstrasse will give you a feel for the city as you visit museums and restaurants.  If you visit in the winter the Christmas markets are a fantastic site and unusual experience with the outdoor shops and stands to by some mulled wine.  If you have time it is worth going to Salzburg for a night to take in this beautiful city nestled in the mountains.',
            duration: 'You could get a good feel for Vienna in 3 days, but you should spend a week in Austria to take everything in and make the long flight worth it.',
            image: 'dist/img/vienna.jpg'
        }, {
            number: 85,
            name: 'Vienna',
            description: 'Vienna is a city with a ton of history and unique culture. Walking the Ringstrasse will give you a feel for the city as you visit museums and restaurants.  If you visit in the winter the Christmas markets are a fantastic site and unusual experience with the outdoor shops and stands to by some mulled wine.  If you have time it is worth going to Salzburg for a night to take in this beautiful city nestled in the mountains.',
            ...
            number: 93,
            name: 'Kenya',
            description: 'Kenya has some of the most amazing wildlife in the world and going on Safari will be an experience you never forget. The Masai Mara game park is the largest park and the place you will see the most animals.  If you go in the months of July through October you will see the wildebeest migration as more than two million wildebeest cover the landscape.  Hire a guide to help you figure out where the best places to view animals is for the day and set out to spot the big five. If you have more time and want to explore more of Kenya then you should venture to Lake Turkana to view the amazing lake and its tribal fishing communities.',
            duration: 'You should give yourself at least a week to see what Kenya has to offer',
            image: 'dist/img/kenya.jpg'
        }, {
            number: 94,
            name: 'Kenya',
            description: 'Kenya has some of the most amazing wildlife in the world and going on Safari will be an experience you never forget. The Masai Mara game park is the largest park and the place you will see the most animals.  If you go in the months of July through October you will see the wildebeest migration as more than two million wildebeest cover the landscape.  Hire a guide to help you figure out where the best places to view animals is for the day and set out to spot the big five. If you have more time and want to explore more of Kenya then you should venture to Lake Turkana to view the amazing lake and its tribal fishing communities.',
        ...
        },
        {
            number: 101,
            name: 'Guatemala',
            description: 'Guatemala is a trip that is well worth visiting due to its amazing sites and ancient ruins.  It is also very easy to get to, which makes it extra appealing.  After flying into Guatemala city you should take a bus or arrange a driver to bring you to Antigua and stay the night in this small city that sits beneath a volcano.  Set out from here to spend a relaxing night or two at Lago de Atitlan, which is a beautiful lake with twin volcanoes in the background.  Tikal is an amazing site with Mayan ruins that should be visited to see the ancient civilization. A more remote site that will take some effort to visit, but is well worth the trip is to visit Semuc Champey. It is a gorgeous site with tiered natural pools to swim in and some caves to explore with a guide. ',
            duration: 'You could see Antigua, Lago de Atitlan and Tikal in 4 or 5 days, but to really enjoy everything and get to Semuc Champey you should spend about a week in Guatemala.',
            image: 'dist/img/guatemala.jpg'
        },
        {
            number: 102,
            name: 'Guatemala',
